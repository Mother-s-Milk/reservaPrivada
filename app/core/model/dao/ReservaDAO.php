...
=======
    final class ReservaDAO extends DAO implements InterfaceDAO {
        ...
        public function update (InterfaceDTO $object): void {
            $sql = "UPDATE {$this->table} SET apellido = :apellido, nombres = :nombres, telefono = :telefono, fecha = :fecha, hora = :hora, personas = :personas, detalles = :detalles, estado = :estado WHERE id = :id";
            $stmt = $this->conn->prepare($sql);
        ...
        public function list (): array {
            $sql = "SELECT apellido, nombres, telefono, fecha, hora, personas, detalles, estado FROM {$this->table}";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute();
