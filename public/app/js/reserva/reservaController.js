      ...
      reservaController.reservas.forEach((reserva) => {
        fila = `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn-confirmar" data-id="${reserva.id}"><i class="fa-solid fa-check"></i></button>
                        <button type="button" class="btn-cancelar" data-id="${reserva.id}"><i class="fa-solid fa-x"></i></button>
